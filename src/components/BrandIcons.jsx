// lucide-react no longer ships brand marks (Github/LinkedIn), so these are
// small hand-rolled equivalents sized and styled to match lucide's icon API
// (size, className, stroke-less fill icons that inherit currentColor).
